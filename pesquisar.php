			...
			<div id='middle'>
			      <form action="pesquisar2.php" method="post" autocomplete="off">
			      	<table class = "form_pesquisar">
				        ...
				        <tr><td>Data:</td><td><input class = "processo" type="date" placeholder="Data inicio" name="data0" autofocus=""></td>
				            <td><input class = "processo" type="date" placeholder="Data final" name="dataf" autofocus=""></td></tr>
